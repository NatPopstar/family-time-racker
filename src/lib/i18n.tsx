...
export const ru = {
  ...
  // Без этой строки человек вписывал ВСЁ время ходки, не зная,
  // что дорога уже посчитана, — и она складывалась дважды.
  'planner.travelAlreadyCounted': 'Дорога уже посчитана',
  'planner.travelOnlyHint': 'Если кроме дороги времени не ушло — оставьте пусто.',
  'planner.plan': 'план',
  'planner.fact': 'факт',
  ...
  'recurring.show': 'Показать список',
  'recurring.hide': 'Свернуть список',
  'recurring.count': 'Повторяющихся событий',
...
export const en: Record<keyof typeof ru, string> = {
  ...
  'planner.travelAlreadyCounted': 'Travel is already counted',
  'planner.travelOnlyHint': 'If nothing beyond the travel was spent, leave it empty.',
  'planner.plan': 'plan',
  'planner.fact': 'actual',
  'planner.spent': 'Spent',
  ...
  'recurring.show': 'Show the list',
  'recurring.hide': 'Collapse the list',
  'recurring.count': 'Repeating events',
